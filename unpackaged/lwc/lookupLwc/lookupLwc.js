...
export default class LookupLwc extends LightningElement {
    ...
    @track cleanSearchTerm;
    @track blurTimeout;
    @track searchThrottlingTimeout;
    @track curSelection = [];

    // Test Pill/Tile Toggle
    @api hideSelection = false;
    @api isTileFormat = false;
    @track tileActions = TILE_ACTIONS;
    ...
    handleRemoveSelectedItem(event) {
        const recordId = event.detail.item.id;
